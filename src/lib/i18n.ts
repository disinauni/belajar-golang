...
export const uiStrings = {
  id: {
    meta: {
      siteTitle: 'Belajar Golang',
      siteDescription: 'Website pembelajaran Go (Golang) untuk siswa SMP dan SMA Indonesia. Dari nol hingga bisa membuat project sederhana.',
      ogTitle: 'Belajar Golang — Untuk SMP/SMA Indonesia',
    },
    nav: {
      home: 'Beranda',
    ...
    code: {
      ...
      apiUnavailable: 'Server tidak tersedia. Coba lagi nanti atau gunakan Go Playground.',
      openOnlineGDB: 'Buka di Go Playground',
    },
    exercise: {
      title: 'Latihan',
    ...
    curriculum: {
      title: 'Kurikulum Go',
      subtitle: 'Dari nol hingga concurrency dan project nyata',
    ...
    home: {
      hero: {
        ...
        description: 'Platform belajar Go (Golang) dalam Bahasa Indonesia. Interaktif, gratis, dan dirancang khusus untuk pelajar Indonesia — sampai ke goroutine dan channel.',
        cta: 'Mulai Belajar',
      ...
      features: {
        interactive: {
          ...
          description: 'Jalankan kode Go langsung di browser tanpa install apapun.',
        },
        bilingual: {
    ...
    playground: {
      title: 'Playground Go',
      description: 'Eksperimen dengan kode Go secara bebas.',
      defaultCode: 'package main\n\nimport "fmt"\n\nfunc main() {\n\tfmt.Println("Halo, Dunia!")\n}',
      tips: 'Tips: Klik "Jalankan" untuk melihat output kode kamu.',
    },
    about: {
      title: 'Tentang Belajar Golang',
      description: 'Platform pembelajaran Go gratis untuk siswa SMP dan SMA Indonesia.',
    },
    errors: {
  ...
  en: {
    meta: {
      siteTitle: 'Learn Go',
      siteDescription: 'Go (Golang) learning platform for Indonesian middle and high school students. From zero to building simple projects.',
      ogTitle: 'Learn Go — For Indonesian Students',
    },
    nav: {
      home: 'Home',
    ...
    code: {
      ...
      runtimeError: 'Runtime Error',
      noOutput: '(No output)',
      apiUnavailable: 'Server unavailable. Try again later or use the Go Playground.',
      openOnlineGDB: 'Open in Go Playground',
    },
    exercise: {
      title: 'Exercise',
    ...
    curriculum: {
      title: 'Go Curriculum',
      subtitle: 'From zero to concurrency and real projects',
    ...
    home: {
      hero: {
        ...
        description: 'A Go (Golang) learning platform in Bahasa Indonesia (and English). Interactive, free, and designed for Indonesian learners — all the way to goroutines and channels.',
        cta: 'Start Learning',
      ...
      features: {
        interactive: {
          ...
          description: 'Run Go code directly in the browser without installing anything.',
        },
        bilingual: {
          title: 'Bahasa Indonesia',
    ...
    playground: {
      title: 'Go Playground',
      description: 'Experiment freely with Go code.',
      defaultCode: 'package main\n\nimport "fmt"\n\nfunc main() {\n\tfmt.Println("Hello, World!")\n}',
      tips: 'Tip: Click "Run" to see your code output.',
    },
    about: {
      title: 'About Learn Go',
      description: 'A free Go learning platform for Indonesian middle and high school students.',
    },
    errors: {
