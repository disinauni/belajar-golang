...
const TOTAL_CURRICULUM_UNITS = 8
...
export function checkAndUnlockBadges(progress: UserProgress): BadgeId[] {
  ...
  // Only true once every curriculum unit has published content AND is done.
  let allUnitsComplete = Object.keys(UNIT_LESSON_COUNTS).length === TOTAL_CURRICULUM_UNITS
