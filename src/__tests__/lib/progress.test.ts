...
const STORAGE_KEY = 'belajar-golang-progress'
...
describe('checkAndUnlockBadges', () => {
  ...
  it('unlock unit-1-complete saat semua 9 lesson unit-1 selesai', () => {
    const lessons = Array.from({ length: 9 }, (_, i) => `unit-1/${String(i + 1).padStart(2, '0')}`)
  ...
  it('tidak unlock unit-1-complete jika kurang dari 9 lesson', () => {
    const p: UserProgress = {
      ...DEFAULT_PROGRESS,
      completedLessons: ['unit-1/01', 'unit-1/02'],
      unlockedBadges: [],
